        ...
        <div className="col-md-8 description">
          <Jumbotron className="description">
            ...
            <p className="lead">
              ...
              Indian Evidence Act to be produced in the court of law. They will
              help you give evidentiary quality content as proof. This could be
              used for any online content which includes social media, blogs and
              even chats or e-mails.
            </p>
            <hr className="my-2" />
